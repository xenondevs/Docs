...
Layers have 2 options: `height`, an [`IntProvider`](../../types/number-provider.md#intprovider) that determines the height of this layer, and `block`, a [`BlockStateProvider`](../../types/block-state-provider.md) that determines the block state to use for this layer.

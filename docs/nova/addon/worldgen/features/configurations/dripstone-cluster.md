...
| `height`                                                      | An [`IntProvider`](../placed-feature.md#int-providers) (Range limit in Json is $[1;128]$)       | The height of the cluster                                                              |
...
| `density`                                                     | A [`FloatProvider`](../placed-feature.md#float-providers). (Range limit in Json is $[0.0;2.0]$) | The density of the dripstone cluster.                                                  |

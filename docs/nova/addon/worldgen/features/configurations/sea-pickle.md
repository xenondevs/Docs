...
The `sea_pickle` feature only has a `count` [`IntProvider`](../../types/number-provider.md#intprovider) option. It determines the max amount of sea pickles per placement.
